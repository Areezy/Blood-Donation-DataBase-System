...
// Custom constructor to pass the user_id to this page
...
//		Query to populate the table with info of all the donor and recipients in the system
...
//		Populating the table with the query result using an external library 
