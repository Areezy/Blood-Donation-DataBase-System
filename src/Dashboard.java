...
//	custom constructor to pass the user id and status id to this class
...
//				Opening the donation center info page for left dashboard item
		...
		contactUs_btn_mid.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
//				Opening the donation center info page for middle dashboard item
		...
		contactUs_btn_right.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
//				Opening the donation center info page for right dashboard item
		...
		donationCenterGroup_btn_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
//				Alogrithm for populating the dashboard items and determining how many need to be replaced when next button is pressed
...
//		Populating the dashboard items initially when the page is first opened
